                                        ...
                                        <div class="mt-2 flex items-center gap-2">
                                            ...
                                            <div x-data="{ showQR: false }" class="relative">
                                                <button 
                                                    @click="showQR = !showQR"
                                                    type="button"
                                                    class="inline-flex items-center px-2 py-0.5 rounded-full text-xs font-medium bg-gray-100 dark:bg-gray-600 text-gray-700 dark:text-gray-200 hover:bg-gray-200 dark:hover:bg-gray-500"
                                                >
